    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <!-- Spinner End -->
            ...
            <nav class="navbar bg-secondary navbar-dark">
                <a href="index.php?action=Page_Dashboard" class="navbar-brand mx-4 mb-3">
      ...
      <div class="content">
             ...
             <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
                <a href="index.php?action=Page_Dashboard" class="navbar-brand d-flex d-lg-none me-4">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="public/img/testimonial-1.jpg" alt="" style="width: 40px; height: 40px;">
                            <span class="d-none d-lg-inline-flex">islam</span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end bg-secondary border-0 rounded-0 rounded-bottom m-0">
                            <a href="#" class="dropdown-item">My Profile</a>
                            <a href="#" class="dropdown-item">Settings</a>
                            <a href="index.php?action=LogOut" class="dropdown-item">Log Out</a>
                        </div>
                    </div>
                    <?php }else {     ?>
                    <a href="index.php?action=form_login" class="nav-link">log in</a>
                        <?php } ?>
                </div>
            </nav>
            <!-- Navbar End -->
